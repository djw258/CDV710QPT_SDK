...
typedef enum LANGUAGE_STRING_TYPE_ID
{
    ...
    DOOR_CAMERA_SEARCH_XLS_LANG_ID_CHECK_INFOMATION,

    DOOR_CAMERA_SEARCH_XLS_LANG_ID_PASSWD_MODIFY_FAIL,

    IP_SETTING_XLS_LANG_ID_IP_SETTING_FAILED,

    IP_SETTING_XLS_LANG_ID_GET_FAILED,

    MONITOR_XLS_LANG_ID_GET_DEVICE_ADJ_INFO_FAILED,

    MONITOR_XLS_LANG_ID_SET_DEVICE_ADJ_INFO_FAILED,

    INSTALLATION_XLS_LANG_ID_IP_CCTV_CAMERA,

    DOOR_CAMERA_SEARCH_XLS_LANG_ID_ENTER_9_DIGITS_OF_NUMBER,

    DOOR_CAMERA_SEARCH_XLS_LANG_ID_SET_9_DIGITS_TO_A_MIXTURE,

    DOOR_CAMERA_SEARCH_XLS_LANG_ID_ENTER_CAMEARA_ID,

    SETTING_GENERAL_XLS_LANG_ID_MANUAL_SETUP,

    SETTING_MOTION_XLS_LANG_ID_CAMERA_NOT_SET,

    INTERCOM_XLS_LANG_ID_CAll_SELECT_ALL,

    SETTING_GENERAL_XLS_LANG_ID_APP_INTEGRATION,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_SELECT_NETWORK,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_CONNECTION_NETWORK,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_ETHERNET,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_CONNECT_STATUS_TITLE,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_CONNECT_STATUS_WARN,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_CONNECTED,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_DISCONNECTED,

    SETTING_APP_INTEGRATION_XLS_LANG_IS_CONNECTABLE,

    // POWER_SETTING_XLS_LANG_ID_NOT_SET,

    POWER_SETTING_XLS_LANG_ID_WILL_REBOOT,

    POWER_SETTING_XLS_LASETTING_PASSWORD_XLS_LANG_ID_EASY_PASSWD,

    SETTING_GENERAL_XLS_LANG_ID_TWO_DOOR_OPEN_BUTTONS,

    SETTING_GENERAL_XLS_LANG_ID_TWO_DOOR_OPEN_APPLY,

    SETTING_GENERAL_XLS_LANG_ID_TWO_DOOR_OPEN_CHANGE_DOOR_METHOD,

    SETTING_GENERAL_XLS_LANG_ID_TWO_DOOR_OPEN_CHANGE_DOOR_NUM,

    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME,

    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_DOOR_MODULE,

    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_1_DOT_5_SEC,
    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_3_SEC,
    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_5_SEC,
    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_7_SEC,
    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_10_SEC,
    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_15_SEC,
    SETTING_GENERAL_XLS_LANG_ID_DOOR_OPEN_DURATION_TIME_20_SEC,
    SETTING_GENERAL_XLS_LANG_ID_DURATION_TIME,
