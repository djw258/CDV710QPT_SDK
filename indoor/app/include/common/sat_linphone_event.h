...
** 说明: 通话音量输入
***********************************************/
bool sat_linphone_audio_input_volume_set(int volume);
...
** 函数说明: 闭麦
** 作者: xiaoxiao
** 日期：2024-04-17 11:05:16
** 参数说明:
** 注意事项：
************************************************************/
bool sat_linphone_mute_mic(void);
/************************************************************
** 函数说明: 开麦
** 作者: xiaoxiao
** 日期：2024-04-17 11:05:42
** 参数说明:
** 注意事项：
************************************************************/
bool sat_linphone_unmute_mic(void);
/***********************************************
** 作者: leo.liu
** 日期: 2022-10-19 8:57:42
** 说明: 铃声音量
