...
FILE_TAR_GZ="SAT_ANYKA3918OS"                                                     #压缩包文件名
...
FILE_ENV="env_v330.img"
FILE_DTB="C300_SQ38_AK3918EV300_GC2063_V1.0.0.dtb"
FILE_KERNEL="uImage"
...
check_files()
{
    ...
    for target in ${FILE_ENV} ${FILE_DTB} ${FILE_KERNEL} ${FILE_ROOT} ${FILE_ETC} ${FILE_USR} ${FILE_APP}
    do
...
{
    for target in ${FILE_ENV} ${FILE_DTB} ${FILE_KERNEL} ${FILE_ROOT} ${FILE_ETC} ${FILE_USR} ${FILE_APP} ${FILE_TAR_GZ}
    do
